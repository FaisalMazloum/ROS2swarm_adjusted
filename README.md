...
## 🛠 Expansions & Adjustments
*   **Adjustments:** Adjusted hardware_protection_layer.py to properly avoid obstacles in all four quadrants, and fixed the normalization of the computed unit vector.
*   **Expansion:** Added adaptive_sampling_pattern.py movement pattern.
